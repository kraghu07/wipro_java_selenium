...
public class Java_Collection {
	...
	public static void main(String[] args)
	{
		...
		depart.add(new Java_Collection().new department("Sales", 20000,15000));
		depart.add(new Java_Collection().new department("Marketing", 3000, 2000));
		depart.add(new Java_Collection().new department("Research", 25000, 20000));
