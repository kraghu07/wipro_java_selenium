...
//        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("ap_customer_name"))).sendKeys("Krish");
//        driver.findElement(By.id("ap_email")).sendKeys("krish@gmail.com");
//        driver.findElement(By.id("ap_password")).sendKeys("krish1234");
//        driver.findElement(By.id("ap_password_check")).sendKeys("krish1234");
//
...
//        driver.findElement(By.id("continue")).click();
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("ap_email"))).sendKeys("krish@gmail.com");
        driver.findElement(By.id("ap_password")).sendKeys("krish1234");
